package a_java.practice.chap11.p20;
// [11-20] 다음은 성적처리 프로그램의 일부이다.
...
public class P20 {
    ...
    static int displayMenu() {
        ...
        while(true){
            ...
            System.out.print("잘못된 입력입니다. 원하는 메뉴를 선택하세요. (1~3) : ");
        }
            ...
            try{
                ...
                if(choice.equals("Q") || choice.equals("q")){
                    ...
                    if(list.length != 6) System.out.println("잘못된 입력입니다.");
                        ...
                        System.out.println("입력이 완료되었습니다. 입력을 마치려면 Q/q를 입력하세요");
                    }
                }
            }catch (Exception e){
                e.printStackTrace();
                //System.out.println("잘못된 입력입니다. 이름,반,번호,국어성적,영어성적,수학성적'의 순서로 공백없이 입력하세요.");
            }
        } // end of while
