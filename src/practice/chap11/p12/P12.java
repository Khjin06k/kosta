...
class SutdaDeck {
    ...
    SutdaCard pick() throws Exception {
            SutdaCard c = null;
            if(0 <= pos && pos < CARD_NUM) { c = cards[pos];
                cards[pos++] = null; }else{
...
class Player {
    ...
    Player(String name, SutdaCard c1, SutdaCard c2) { this.name = name ;
        this.c1 = c1 ;
        this.c2 = c2 ;
    }
...
public class P12 {
    public static void main(String args[]) throws Exception {
        ...
        deck.shuffle();
        Player p1 = new Player("타짜", deck.pick(), deck.pick()); Player p2 = new Player("고수", deck.pick(), deck.pick());
